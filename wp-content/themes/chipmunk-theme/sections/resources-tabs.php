		...
		<div class="container" data-tabs role="tablist">
			...
			<?php if ( $resources['latest']->have_posts() ) : ?>
				<div>
					...
					<?php if ( $resources['latest']->have_posts() ) : ?>
						<h2 class="cc-heading<?php echo ! $resources['featured']->have_posts() ? ' active' : ''; ?>" data-tabs-toggle role="tab">
					...
					<?php if ( $resources['popular']->have_posts() ) : ?>
						<h2 class="cc-heading<?php echo ! $resources['featured']->have_posts() ? '' : ' visible-sm-inline-block'; ?>" data-tabs-toggle role="tab">
